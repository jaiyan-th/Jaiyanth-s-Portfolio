        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
          ...
          >
            ...
            <div className="inline-block">
              <span className="sticker-badge bg-[#111111] text-white -rotate-2 text-xs sm:text-sm py-1.5 px-3">
            ...
            {/* Subhead */}
            <p className="font-body text-lg sm:text-xl lg:text-[1.3rem] text-[#333333] leading-relaxed max-w-2xl xl:max-w-3xl font-normal">
            ...
            <div className="pt-2 sm:pt-4 flex flex-wrap items-center gap-6">
              ...
              <a
                href="#work"
                className="font-body text-base sm:text-lg font-semibold text-[#111111] underline underline-offset-4 decoration-2 decoration-[#111111] hover:opacity-75 transition-opacity inline-flex items-center gap-1.5"
              >
                See the work →
              </a>
            </div>
          ...
          >
            <div className="neo-card p-6 sm:p-7 lg:p-8 relative bg-white w-full">
              {/* Card top tape / tag */}
              <div className="flex items-center justify-between border-b-2 border-[#111111] pb-3.5">
                <span className="font-label-caps text-xs sm:text-[13px] tracking-wider text-[#555555]">
                  QUICK SNAPSHOT
                </span>
                <span className="sticker-badge bg-[#111111] text-white text-[11px] py-0.5 px-2.5 rotate-1">
                  2026
                </span>
              </div>
              ...
              <div className="divide-y-[1.5px] divide-[#111111]/15">
                ...
                <div className="pt-4 pb-4 sm:pt-4.5 sm:pb-4.5">
                  <div className="flex items-center gap-1.5 font-label-caps text-[11px] sm:text-xs text-[#777777] mb-1.5">
                    <MapPin className="w-3.5 h-3.5 text-[#111111]" />
                    <span>LOCATION</span>
                  </div>
                  <p className="font-body text-sm sm:text-base font-semibold text-[#111111] leading-snug">
                ...
                <div className="pt-4 pb-4 sm:pt-4.5 sm:pb-4.5">
                  ...
                  <p className="font-mono-code text-xs sm:text-sm font-bold text-[#111111] leading-relaxed">
                ...
                <div className="pt-4 sm:pt-4.5">
                  <div className="flex items-center gap-1.5 font-label-caps text-[11px] sm:text-xs text-[#777777] mb-2">
                    <Sparkles className="w-3.5 h-3.5 text-[#111111]" />
                    <span>STATUS</span>
                  </div>
                  <div className="bg-[#FAF3EE] border-[1.5px] border-[#111111] px-4 py-3">
                    <p className="font-body text-xs sm:text-sm font-semibold text-[#111111] leading-snug">
