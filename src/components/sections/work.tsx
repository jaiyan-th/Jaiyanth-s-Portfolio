...
export function Work() {
  ...
  return (
    <section id="work" className="relative bg-[#C2B5A3] border-b-2 border-black py-12 md:py-20 text-black overflow-hidden grid-scan" style={{ backgroundImage: "linear-gradient(rgba(0, 0, 0, 0.07) 1px, transparent 1px), linear-gradient(90deg, rgba(0, 0, 0, 0.07) 1px, transparent 1px)", backgroundSize: "48px 48px" }}>
