        ...
        <div className="border-t-2 border-black divide-y-2 divide-black">
          {PROJECTS.map((project) => (
            ...
            >
              ...
              <div className="border-l-4 border-[#9E0020] bg-white p-3.5 border border-black shadow-[3px_3px_0px_#000000] max-w-3xl">
              ...
              <div className="pt-2 flex flex-wrap items-center gap-4">
                <motion.button
                  ...
                  className="bg-black text-white font-mono text-xs font-black uppercase tracking-widest px-5 py-3 border-2 border-black shadow-[2px_2px_0px_#9E0020] inline-flex items-center gap-2 cursor-pointer"
                >
                  <span>INSPECT CASE STUDY</span>
                  <ArrowRight className="w-4 h-4 text-[#9E0020]" />
                </motion.button>
                ...
                {project.liveUrl && (
                  <a
                    ...
                    className="bg-white text-black font-mono text-xs font-black uppercase tracking-widest px-5 py-3 border-2 border-black shadow-[2px_2px_0px_#000000] hover:bg-[#9E0020] hover:text-white transition-colors inline-flex items-center gap-1.5"
                  >
                    <span>LIVE DEMO</span>
