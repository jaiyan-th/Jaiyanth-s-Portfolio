...
export function Skills() {
  ...
  return (
    <section id="skills" className="relative bg-[#FFFFFF] border-b-2 border-[#E5DCD0] px-4 sm:px-6 lg:px-8 py-12 md:py-20 text-[#561C24] bg-grid">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-12 gap-8 items-stretch">
          ...
          <div className="lg:col-span-5 flex flex-col">
            <div className="bg-[#F5EFE6] p-6 sm:p-8 border-2 border-[#561C24] shadow-[5px_5px_0px_#561C24] relative flex-1 flex flex-col justify-between rounded-sm">
              {/* Viewfinder corners */}
              ...
              <div className="border-b-2 border-[#E5DCD0] pb-3 mb-4">
                    ...
                    <motion.button
                      ...
                      className={`w-full text-left font-mono text-xs uppercase py-3.5 px-4 flex items-center justify-between group transition-all relative border-2 ${
                        isSelected
                          ...
                          : "border-[#E5DCD0] bg-white text-[#561C24] hover:border-[#561C24] hover:bg-[#561C24]/5"
                      }`}
                    >
                      <div className="flex items-center gap-3 relative z-10">
                        <span className={`text-[10px] font-black ${isSelected ? "text-white/80" : "text-[#561C24]/60"}`}>{cat.index}</span>
                      ...
                      <div className="flex items-center gap-3 relative z-10">
                        <span className={`text-[9px] font-bold ${isSelected ? "text-white/80" : "text-[#561C24]/60"}`}>
            ...
            <div className="bg-white p-6 sm:p-8 border-2 border-[#561C24] shadow-[5px_5px_0px_#6D2932] relative flex-1 flex flex-col rounded-sm">
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  <div>
                    {/* Spec Sheet Header */}
                    <div className="flex items-center justify-between border-b-2 border-[#E5DCD0] pb-4 mb-5">
                      <div className="font-mono text-[10px] font-black uppercase tracking-wider text-[#561C24]">
                        {currentGroup.index} · {currentGroup.label}
                      </div>
                      <span className="font-mono text-[9px] text-[#6D2932] font-black uppercase tracking-widest bg-[#F5EFE6] border border-[#E5DCD0] px-2 py-0.5">
                        ACTIVE COMPETENCY
                      </span>
                    </div>
                  ...
                  <div className="space-y-4 border-t-2 border-b-2 border-[#E5DCD0] py-4 mt-2 mb-4">
                    <div className="grid sm:grid-cols-3 gap-2 font-mono text-[10px]">
                      <span className="text-[#561C24]/60 font-bold uppercase">DOMAIN:</span>
                    ...
                    <div className="grid sm:grid-cols-3 gap-2 font-mono text-[10px] items-start">
                      <span className="text-[#561C24]/60 font-bold uppercase">COMPETENCIES:</span>
                      <div className="sm:col-span-2 flex flex-wrap gap-2">
                        {currentGroup.skills.map((skill) => (
                          <motion.span
                            key={skill}
                            whileHover={{ y: -2, scale: 1.04, borderColor: "#6D2932" }}
                            className="px-3 py-1 border-2 border-[#561C24] bg-[#F5EFE6] text-[#561C24] text-[10px] font-black shadow-[2px_2px_0px_#6D2932] cursor-default transition-colors"
                          >
                            {skill}
                          </motion.span>
                        ))}
                    ...
                    <div className="grid sm:grid-cols-3 gap-2 font-mono text-[10px] items-start">
                      <span className="text-[#561C24]/60 font-bold uppercase">EVIDENCE:</span>
                    ...
                    {currentGroup.impact && (
                      <div className="grid sm:grid-cols-3 gap-2 font-mono text-[10px] items-start pt-1">
                        <span className="text-[#561C24]/60 font-bold uppercase">IMPACT:</span>
                  ...
                  <div className="p-4 border-2 border-[#561C24] bg-[#F5EFE6] shadow-[3px_3px_0px_#561C24] mt-auto">
                    <div className="flex items-center justify-between font-mono text-[9.5px] font-black uppercase text-[#561C24] border-b border-[#E5DCD0] pb-2 mb-2">
