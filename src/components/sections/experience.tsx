...
export function Experience() {
  return (
    <section id="experience" className="relative bg-[#FAF3EE] border-b-2 border-black px-4 sm:px-6 lg:px-8 py-12 md:py-20 text-black bg-grid">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8 items-stretch">
          ...
          <motion.div
            ...
            whileHover={{ y: -4, x: -2, boxShadow: "6px 6px 0px #000000" }}
            className="border-2 border-black p-6 sm:p-8 bg-white shadow-[4px_4px_0px_#000000] relative flex flex-col justify-between rounded-sm"
          >
            {/* Viewfinder corners */}
            ...
            <div>
              ...
              <h3 className="font-heading font-black text-lg sm:text-2xl text-black uppercase mb-1 leading-[1.08]">
                {EXPERIENCE.role}
              </h3>

              <span className="font-mono text-[11px] uppercase tracking-wider font-black text-[#B91C1C] inline-block mb-6">
          ...
          <motion.div
            ...
            viewport={{ once: true, margin: "-80px" }}
            transition={{ duration: 0.6, ease: "easeOut" }}
            whileHover={{ y: -4, x: -2, boxShadow: "6px 6px 0px #B91C1C" }}
            className="border-2 border-black p-6 sm:p-8 bg-white shadow-[4px_4px_0px_#B91C1C] relative rounded-sm"
          >
            {/* Viewfinder corners */}
            <span className="blueprint-corner blueprint-corner-tl" />
            <span className="blueprint-corner blueprint-corner-tr" />
            ...
            <div className="flex items-center justify-between border-b-2 border-black pb-4 mb-6">
              ...
              <span className="font-mono text-[9px] text-black font-black uppercase bg-black/5 px-2 py-0.5 border border-black/20">
                8 STAGES
              </span>
            </div>
            ...
            <div className="relative pl-6 space-y-3.5">
              ...
              <div className="absolute left-[7px] top-2 bottom-2 w-[2px] bg-black/20" />
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      {/* Node point */}
                      <div className="absolute left-[-23px] w-3 h-3 rounded-full border-2 border-black bg-white flex items-center justify-center group-hover:bg-[#B91C1C] transition-colors">
                        <span className="w-1.5 h-1.5 rounded-full bg-[#B91C1C] group-hover:bg-white" />
                      </div>
                      <span className="font-mono text-[10px] font-black text-black uppercase tracking-wider group-hover:text-[#B91C1C] transition-colors">
                        {item}
                      </span>
                    </div>
                    <span className="font-mono text-[9px] text-black/50 font-black">
                      {stageNum}
                    </span>
                  </motion.div>
                );
