    ...
    <html lang="en" suppressHydrationWarning>
      ...
      >
        <ThemeProvider>
          ...
          <a
            href="#main"
            className="sr-only focus:not-sr-only focus:fixed focus:top-4 focus:left-4 focus:z-[100] focus:px-4 focus:py-2 focus:bg-[#D9622B] focus:text-white focus:text-sm focus:font-bold focus:border-2 focus:border-black"
          >
            Skip to content
          </a>
          {children}
